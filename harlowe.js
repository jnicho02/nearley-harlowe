...
var grammar = {
    ...
    {"name": "passage$ebnf$1$subexpression$1", "symbols": ["narrative"]},
    ...
    {"name": "narrative", "symbols": [/[\w\s."'^\(\)\[\]]/], "postprocess": id},
    ...
    {"name": "set", "symbols": ["set$string$1", "variable", "set$string$2", "boolean", {"literal":")"}], "postprocess": d => {return {set:d[1], to:d[3]} }},
    ...
    {"name": "if$string$3", "symbols": [{"literal":"("}, {"literal":"i"}, {"literal":"f"}, {"literal":":"}, {"literal":" "}, {"literal":"!"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "if$string$4", "symbols": [{"literal":")"}, {"literal":"["}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "if", "symbols": ["if$string$3", "variable", "if$string$4", "passage", {"literal":"]"}], "postprocess": d => {return {ifnot:d[2], then:d[4]} }},
    ...
    {"name": "clickable$ebnf$1", "symbols": [/[\w\s]/]},
    {"name": "clickable$ebnf$1", "symbols": ["clickable$ebnf$1", /[\w\s]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "clickable$string$1", "symbols": [{"literal":"]"}, {"literal":"<"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "clickable", "symbols": [{"literal":"["}, "clickable$ebnf$1", "clickable$string$1", "subroutine", {"literal":"|"}], "postprocess": d => {return {link:d[1].join(""), run:d[3]} }},
    {"name": "clickreplace$string$1", "symbols": [{"literal":"("}, {"literal":"c"}, {"literal":"l"}, {"literal":"i"}, {"literal":"c"}, {"literal":"k"}, {"literal":"-"}, {"literal":"r"}, {"literal":"e"}, {"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":":"}, {"literal":" "}, {"literal":"?"}, {"literal":"p"}, {"literal":"i"}, {"literal":"c"}, {"literal":"k"}, {"literal":"u"}, {"literal":"p"}, {"literal":")"}, {"literal":"["}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "clickreplace", "symbols": ["clickreplace$string$1", "passage", {"literal":"]"}], "postprocess": id},
    ...
    {"name": "subroutine$ebnf$1", "symbols": [/[\w\s]/]},
    {"name": "subroutine$ebnf$1", "symbols": ["subroutine$ebnf$1", /[\w\s]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "subroutine", "symbols": ["subroutine$ebnf$1"], "postprocess": d => {return {type:'subroutine', v:d[0].join("")}}},
